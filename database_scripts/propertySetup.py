# When you initialize this dataset, you will want to run with all the api links.
# After initialization, remove the past years as they will not be updated.
# Each dataset has about 144163 lines. Each takes about 10 minutes to run.
# 2004~2023 will have around 2739097 records.
# Running the whole script with all the api links can take you over 3 hours.
import time
import requests
import re
from sqlalchemy import create_engine, MetaData, Table, Column, Text, Integer, exc, PrimaryKeyConstraint
